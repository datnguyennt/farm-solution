...
class AppTextStyle {
  ...
  static TextStyle regular20({required Color color}) => TextStyle(
      fontSize: _getFontSize(20.0), color: color, fontFamily: 'Inter');

  static TextStyle regular24({required Color color}) => TextStyle(
      fontSize: _getFontSize(24.0), color: color, fontFamily: 'Inter');

  static TextStyle regular18({required Color color}) => TextStyle(
      fontSize: _getFontSize(18.0), color: color, fontFamily: 'Inter');

  static TextStyle regular16({required Color color}) => TextStyle(
      fontSize: _getFontSize(16.0), color: color, fontFamily: 'Inter');

  static TextStyle regular14({required Color color}) => TextStyle(
      fontSize: _getFontSize(14.0), color: color, fontFamily: 'Inter');

  static TextStyle regular13({required Color color}) => TextStyle(
      fontSize: _getFontSize(13.0), color: color, fontFamily: 'Inter');

  static TextStyle regular12({required Color color}) => TextStyle(
      fontSize: _getFontSize(12.0), color: color, fontFamily: 'Inter');

  static TextStyle regular11({required Color color}) => TextStyle(
      fontSize: _getFontSize(11.0), color: color, fontFamily: 'Inter');

  static TextStyle regular10({required Color color}) => TextStyle(
      fontSize: _getFontSize(10.0), color: color, fontFamily: 'Inter');

  static TextStyle regular9({required Color color}) =>
      TextStyle(fontSize: _getFontSize(9.0), color: color, fontFamily: 'Inter');

  static TextStyle regular8({required Color color}) =>
      TextStyle(fontSize: _getFontSize(8.0), color: color, fontFamily: 'Inter');

  static TextStyle regular7({required Color color}) =>
      TextStyle(fontSize: _getFontSize(7.0), color: color, fontFamily: 'Inter');

  static TextStyle regular6({required Color color}) =>
      TextStyle(fontSize: _getFontSize(6.0), color: color, fontFamily: 'Inter');
