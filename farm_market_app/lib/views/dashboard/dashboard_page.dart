...
class DashBoardPage extends GetView<DashboardController> {
  ...
  Container listPost(List<Post> arrPost) {
    return Container(
      height: 280.h,
      alignment: Alignment.center,
  ...
  InkWell itemPost(int id, String image, String name, String author,
      double price, String distance) {
    return InkWell(
      onTap: () {
        Get.toNamed(Routes.POST_DETAIL, arguments: id);
      },
      child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        controller.formatCurrency.format(price),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
