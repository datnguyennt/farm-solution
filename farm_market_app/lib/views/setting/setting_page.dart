            ...
            child: Stack(
              children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: Container(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              imageUrl: EndPoint.baseUrl + Globals.mainUser.avatar
                                                  .toString(),
                ...
                GetX<SettingController>(
                  builder: (_controller) => Positioned(
                    top: Get.height * 0.25,
                    left: 25,
                    right: 25,
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          ItemSetting(
                            action: () {
                              print('change_password'.tr);
                              Globals.mainUser.fullName == null
                                  ? _controller.showLogin()
                                  : Get.toNamed(Routes.CHANGE_PASSWORD);
                            },
                            title: 'change_password'.tr,
                            icon: AppImages.iconChangePassword,
                            color: AppColor.changePasswordBg,
                          ),
                          Divider(color: AppColor.grayDivider),
                          ItemSetting(
                            action: () {
                          ...
                          ItemSetting(
                            action: () {
                              print('payment'.tr);
                              Globals.mainUser.fullName == null
                                  ?Get.toNamed(Routes.PAYMENT) // _controller.showLogin()
